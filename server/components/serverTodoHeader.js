//this is the serverTodoHeader.js file in the components folder in the server side

import React from 'react';
import { connect } from 'react-redux';
import { setVisibilityFilter } from '../actions/visibilityFilter';

class serverTodoHeader extends React.Component {
    constructor(props) {
        super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(serverTodoHeader);
